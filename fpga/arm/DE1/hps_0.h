...
/*
 * Macros for device 'dx_corr', class 'altera_avalon_pio'
 * The macros are prefixed with 'DX_CORR_'.
 * The prefix is the slave descriptor.
 */
#define DX_CORR_COMPONENT_TYPE altera_avalon_pio
#define DX_CORR_COMPONENT_NAME dx_corr
#define DX_CORR_BASE 0x310
#define DX_CORR_SPAN 32
#define DX_CORR_END 0x32f
#define DX_CORR_BIT_CLEARING_EDGE_REGISTER 0
#define DX_CORR_BIT_MODIFYING_OUTPUT_REGISTER 0
#define DX_CORR_CAPTURE 0
#define DX_CORR_DATA_WIDTH 10
#define DX_CORR_DO_TEST_BENCH_WIRING 0
#define DX_CORR_DRIVEN_SIM_VALUE 0
#define DX_CORR_EDGE_TYPE NONE
#define DX_CORR_FREQ 56000000
#define DX_CORR_HAS_IN 1
#define DX_CORR_HAS_OUT 0
#define DX_CORR_HAS_TRI 0
#define DX_CORR_IRQ_TYPE NONE
#define DX_CORR_RESET_VALUE 0

/*
 * Macros for device 'y_cut', class 'altera_avalon_pio'
 * The macros are prefixed with 'Y_CUT_'.
 * The prefix is the slave descriptor.
 */
#define Y_CUT_COMPONENT_TYPE altera_avalon_pio
#define Y_CUT_COMPONENT_NAME y_cut
#define Y_CUT_BASE 0x320
#define Y_CUT_SPAN 32
#define Y_CUT_END 0x33f
#define Y_CUT_BIT_CLEARING_EDGE_REGISTER 0
#define Y_CUT_BIT_MODIFYING_OUTPUT_REGISTER 0
#define Y_CUT_CAPTURE 0
#define Y_CUT_DATA_WIDTH 10
#define Y_CUT_DO_TEST_BENCH_WIRING 0
#define Y_CUT_DRIVEN_SIM_VALUE 0
#define Y_CUT_EDGE_TYPE NONE
#define Y_CUT_FREQ 56000000
#define Y_CUT_HAS_IN 0
#define Y_CUT_HAS_OUT 1
#define Y_CUT_HAS_TRI 0
#define Y_CUT_IRQ_TYPE NONE
#define Y_CUT_RESET_VALUE 0
...
#define SYSID_QSYS_TIMESTAMP 1444304653
