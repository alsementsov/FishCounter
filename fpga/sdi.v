...
module sdi (
	...
	parameter QTB_devicefamily = "Cyclone V";
	parameter QTB_dlparam = "false";
	parameter QTB_dsparam = "false";
	parameter QTB_duplex = "false";
	parameter QTB_hdparam = "true";
	parameter QTB_mrparam = "false";
	parameter QTB_multiXcvrText0 = "Device Behavior for Multiple Transceivers";
	parameter QTB_multiXcvrText1 = "Cyclone V devices have two transmit PLLs per transceiver block allowing each";
	parameter QTB_multiXcvrText2 = "transmitter to run at one of two independent rates.";
	parameter QTB_multiXcvrText3 = "Receivers in a transceiver block share a common training clock, but have ";
	parameter QTB_multiXcvrText4 = "independent receiver PLLs. Because the same training clock is used for SD and ";
	parameter QTB_multiXcvrText5 = "HD SDI,receivers can accommodate the different standards within a single ";
	parameter QTB_multiXcvrText6 = "transceiver block.";
	parameter QTB_multiXcvrText7 = "TX CLK MUX feature is not supported.";
	...
	defparam
		...
		sdi_megacore_top_inst.SELECT_FAMILY = "Cyclone V",
		sdi_megacore_top_inst.SELECT_NATIVEPHY = 1'b1;
endmodule
...
// Retrieval info: <MEGACORE title="SDI MegaCore Function"  version="13.1"  build="162"  iptb_version="1.3.0 Build 162"  format_version="120" >
...
// Retrieval info:      <PRIVATE name = "standard" value="HD"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "hdparam" value="true"  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "multiXcvrText1" value="Cyclone V devices have two transmit PLLs per transceiver block allowing each"  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "multiXcvrText2" value="transmitter to run at one of two independent rates."  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "multiXcvrText3" value="Receivers in a transceiver block share a common training clock, but have "  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "multiXcvrText4" value="independent receiver PLLs. Because the same training clock is used for SD and "  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "multiXcvrText5" value="HD SDI,receivers can accommodate the different standards within a single "  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "multiXcvrText6" value="transceiver block."  type="STRING"  enable="1" />
// Retrieval info:      <PRIVATE name = "multiXcvrText7" value="TX CLK MUX feature is not supported."  type="STRING"  enable="1" />
...
// Retrieval info:      <PRIVATE name = "filename" value="sdi_syn.v"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
// Retrieval info:     <NAMESPACE name = "simgen">
// Retrieval info:      <PRIVATE name = "filename" value="sdi.vo"  type="STRING"  enable="1" />
// Retrieval info:     </NAMESPACE>
...
// Retrieval info:     <CONSTANT name = "SELECT_FAMILY" value="Cyclone V"  type="STRING" />
// Retrieval info:     <CONSTANT name = "SELECT_NATIVEPHY" value="1"  type="HDL_VECTOR"  radix="BINARY"  width="1"  vhdl_type="STD_LOGIC_VECTOR" />
// Retrieval info:    </CONSTANTS>
...
// Retrieval info:     <PORT name = "sdi_reconfig_fromgxb" direction="OUTPUT"  connect_to="sdi_reconfig_fromgxb"  default="NODEFVAL"  high_width="91"  low_width="0"  description="" />
// Retrieval info:     <PORT name = "sdi_reconfig_togxb" direction="INPUT"  connect_to="sdi_reconfig_togxb"  default="NODEFVAL"  high_width="139"  low_width="0"  description="" />
// Retrieval info:    </PORTS>
